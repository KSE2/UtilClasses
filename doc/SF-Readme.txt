...
- RELEASE SECURITY
Downloads can be verified using the signature files and GnuPG (http://www.gnupg.org) or PGP and download of the public RSA key Wolfgang Keller 253BCEA2FDA84387 <neolith@uber.space> from a public key server.
